...
import static org.anasoid.poc.jpa.mtm.domain.CategoryAsserts.*;
import static org.anasoid.poc.jpa.mtm.web.rest.TestUtil.createUpdateProxyForBean;
...
class CategoryResourceIT {
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.code(UPDATED_CODE).name(UPDATED_NAME);
